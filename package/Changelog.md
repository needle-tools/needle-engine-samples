...
## [1.5.1] - 2026-06-30
- Update: FastHDR sample now also switches background/skybox
- Remove: DeployToGlitch sample
- Cleanup: Sandbox scene (removed Avatar component from SyncedCamera, removed obsolete AvatarBlink component)
- Minor adjustments to Spritesheets samples
...
## [1.4.1] - 2026-02-09
- Update image-tracking sample
- Update MaterialX sample

## [1.4.0] - 2026-02-03
- Update Needle Engine dependency to 4.12.2
