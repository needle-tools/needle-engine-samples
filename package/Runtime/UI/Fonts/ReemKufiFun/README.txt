...
This means all the styles are contained in a single file:
  ReemKufiFun-VariableFont_wght.ttf

If your app fully supports variable fonts, you can now pick intermediate styles
that aren’t available as static fonts. Not all apps support variable fonts, and
in those cases you can use the static font files for Reem Kufi Fun:
  static/ReemKufiFun-Regular.ttf
  static/ReemKufiFun-Medium.ttf
  static/ReemKufiFun-SemiBold.ttf
  static/ReemKufiFun-Bold.ttf
