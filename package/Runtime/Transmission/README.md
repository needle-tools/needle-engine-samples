...
This sample showcases the Transmission effect, that takes the rendereder frame of opaque objects and then uses it to bend the image to mimic refraction.